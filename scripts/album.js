...
var createSongRow = function(songNumber, songName, songLength) {
  ...
  var clickHandler = function() {
    ...
    if (currentlyPlayingSongNumber !== null) {
      ...
      //We check if there's a song playing, and if so we make sure remove any icons and put its number back
    ...
    //The above and below are separated for simplicity.  We always want to check if there's a song playing
    //when something is clicked and set song number back to the number, then the below will decide if and
    //where an icon should be placed.
